package com.example.demo.complexImport.example2;
...
public class EasyExcelUtil {
    ...
    public static Map<String,Object> readExcel(File file, BaseRowModel rowModel, int sheetNo) throws IOException {
        Map<String,Object> result = new HashMap<>();
        ExcelListener excelListener = new ExcelListener();
    ...
    private static ExcelReader getReader(File file, ExcelListener excelListener) throws IOException {
